...
const INITIAL_CATEGORIES: Category[] = [
    // ESTAÇÃO/COLEÇÃO
    { id: 'cat-001', name: 'Verão', slug: 'verao', type: 'season', icon: '☀️', color: '#F59E0B', description: 'Produtos para a estação de verão', active: true, order: 1, productCount: 45, parent: null, children: [] },
    { id: 'cat-002', name: 'Inverno', slug: 'inverno', type: 'season', icon: '❄️', color: '#3B82F6', description: 'Produtos para a estação de inverno', active: true, order: 2, productCount: 38, parent: null, children: [] },
    // LINHA/MARCA
    { id: 'cat-011', name: 'Premium', slug: 'premium', type: 'brand', icon: '⭐', color: '#1E40AF', description: 'Linha premium com alta qualidade', active: true, order: 1, productCount: 52, parent: null, children: [] },
    { id: 'cat-012', name: 'Básico', slug: 'basico', type: 'brand', icon: '✓', color: '#6B7280', description: 'Linha básica com bom custo-benefício', active: true, order: 2, productCount: 67, parent: null, children: [] },
    // CATEGORIAS DE PRODUTO
    { id: 'cat-031', name: 'Conjuntos', slug: 'conjuntos', type: 'product', icon: '👕', color: '#1E40AF', description: 'Conjuntos completos', active: true, order: 1, productCount: 45, parent: null, children: [] },
    { 
        id: 'cat-032', name: 'Camisetas', slug: 'camisetas', type: 'product', icon: '👔', color: '#10B981', description: 'Camisetas diversas', active: true, order: 2, productCount: 32, parent: null, 
        children: [
            { id: 'cat-032-1', name: 'Manga Curta', slug: 'manga-curta', type: 'product_sub', icon: '👕', color: '#10B981', active: true, productCount: 20, order: 1 },
            { id: 'cat-032-2', name: 'Manga Longa', slug: 'manga-longa', type: 'product_sub', icon: '👕', color: '#10B981', active: true, productCount: 12, order: 2 }
        ] 
    },
];
